...
class CoClustering(AlgoBase):
    ...
    def compute_averages(self, cltr_u, cltr_i):
        ...
        for u, i, r in self.trainset.all_ratings():
            ...
            sum_cltr_u[uc] += np.average(r)
            sum_cltr_i[ic] += np.average(r)
            sum_cocltr[uc, ic] += np.average(r)
        ...
        for uc in range(self.n_cltr_u):
            if count_cltr_u[uc]:
                ...
                avg_cltr_u[uc] = np.average(global_mean)
        ...
        for ic in range(self.n_cltr_i):
            if count_cltr_i[ic]:
                ...
                avg_cltr_i[ic] = np.average(global_mean)
        ...
        for uc in range(self.n_cltr_u):
            for ic in range(self.n_cltr_i):
                if count_cocltr[uc, ic]:
                    ...
                    avg_cocltr[uc, ic] = np.average(global_mean)
